    ...
    render() {
        ...
        return (
            <div  className='firsttraining-container'>
                <h2 className='firsttraining-addition-first'>Для того, чтобы вычислить Вашу суточную норму жидкости, укажи Ваш
                    вес.</h2>
                <p className='firsttraining-enter-weight'>Введите свой вес в килограммах:</p>
                <input type="number" min="1" max="250" id="weight"  onChange={this.onChange} placeholder='от 10 до 299' className='firsttraining-weight'/>
